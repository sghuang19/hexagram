...
/**
 * I'm not completely following the original order set by King Wen here. For the
 * first two hexagrams, 111 111 -> 111 110 (top line changes), therefore binary
 * decrement is used to calculate the next hexagram.
 */
